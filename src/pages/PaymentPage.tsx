...
function hasPayableSummary(
  payment: Payment
): payment is Payment & { payableSummary: PayableSummaryItem[] } {
...
const PaymentPage = () => {
  ...
  const isAchOrWire = useMemo(
    () => selectedMethod === 'ach' || selectedMethod === 'wire',
    [selectedMethod]
  );
  const isSmartDisburse = useMemo(
    () => selectedMethod === 'smart-disburse',
    [selectedMethod]
  );
  ...
  const fundingAmountValue = useMemo(() => {
    ...
    if (selectedFundingMethod === 'add-funds')
      return addFundsAmount.toLocaleString('en-US', {
        minimumFractionDigits: 2,
        maximumFractionDigits: 2,
      });
    return '12,034.50';
  ...
  const handleCopy = useCallback(() => {
    if (!payment) return;
    navigator.clipboard
      .writeText(payment.billReference)
      ...
      footer={
        <div className="flex flex-col gap-2 w-full">
          <div className="flex items-center gap-2 w-full justify-end">
            <Button size="md" onClick={() => handlePayClick(payment)}>
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-6 border-y border-gray-200 py-5">
          ...
          <div className="font-medium">
            ...
            <div className="flex items-center">
              <span className="text-base font-gray-700">
              ...
              {isCardMethod && (
                <div className="mt-4">
                  ...
                  <div className="mt-2.5 text-sm text-gray-500 leading-5">
                    Simply load your card with the amount of the invoice, and
                    send the card to your customer for a hassle-free checkout
                    experience.
                  </div>
                  <div className="mt-4">
                    <WrapSelect
                        ...
                        <div className="flex items-center p-4 space-x-6">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-900">
                              ...
                              {!(
                                selectedFundingMethod === 'match-payment' ||
                                selectedFundingMethod === 'add-funds'
                              ) && (
                                <Icon
                                  icon="exclamation"
                      ...
                      <div className="mt-10">
                        ...
                        <div className="mt-1 grid gap-2.5">
                          {sendingMethods.map((method) => {
                            const isSelected =
                              selectedSendingMethod === method.value;
                            return (
                              <div
                                key={method.value}
                              ...
                              >
                                ...
                                {method.value === 'delivery' && isSelected && (
                                  <div className="px-4 pb-4 grid gap-4">
                                    <div className="text-sm text-gray-500 leading-5">
                                      Provide your payee&apos;s email address
                                      and/or phone number where the card token
                                      will be sent to.
                                    </div>
                                ...
                                {method.value === 'display' && isSelected && (
                                  <div className="px-4 pb-4 text-sm text-gray-500 leading-5">
                                    Please note that card details will be shown
                                    on the final payment confirmation page after
                                    finalizing this invoice for you to send
                                    manually.
                                  </div>
                                )}
                              </div>
                ...
                <div className="mt-4 rounded-lg border border-gray-200 bg-gray-50">
                  <div className="px-4 py-4">
                    ...
                    <div className="mt-2.5 text-sm leading-5 text-gray-500">
                      Provide your payee&apos;s email address and/or phone
                      number where the SMART Disburse payment token will be sent
                      to.
                    </div>
                    <div
                    ...
                    <div className="relative" ref={smartDisburseInputRef}>
                          ...
                          <span
                            ...
                            onKeyDown={(e) => {
                              if (e.key === 'Delete' || e.key === 'Backspace') {
                                ...
                                setTimeout(() => {
                                  document
                                    .getElementById('smart-disburse-input')
                                    ?.focus();
                                }, 0);
                              }
                            }}
                      ...
                      {showErrors &&
                        selectedSmartDisburseContacts.length === 0 && (
        ...
        <div className="flex flex-col gap-6">
                  ...
                  {payment.payableSummary.map((item) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-2 text-sm whitespace-nowrap text-right">
                        {item.price}
                        <span className="pl-1 uppercase text-gray-500">
                          USD
                        </span>
                      </td>
                      <td className="px-6 py-2 text-sm whitespace-nowrap text-right">
          ...
          {payment.vendors && <VendorsToPay payment={payment} />}
        </div>
