...
export const receivables: Receivable[] = [
    ...
    activityLog: [
      {
        ...
        status: 'pending',
        description:
          'Bill for receivable id #2345REQ3 is pending initiation on 06/17/2022',
    ...
    activityLog: [
      {
        id: 'al-ip-1',
        status: 'processing',
        description: 'Bill for receivable id #2345REQ3 is processing',
        timestamp: 'Aug 29, 2023 10:40 AM (EST)',
      },
      {
        id: 'al-ip-2',
        status: 'initiated',
        description: 'Bill for receivable id #2345REQ3 has been initiated',
        timestamp: 'Aug 29, 2023 10:40 AM (EST)',
      },
      {
        id: 'al-ip-3',
        status: 'pending',
        description: 'Bill for receivable id #2345REQ3 is pending billing',
        timestamp: 'Aug 29, 2023 10:40 AM (EST)',
      },
      {
        id: 'al-ip-4',
        status: 'pending',
        description: 'Bill for receivable id #2345REQ3 was created',
        timestamp: 'Aug 28, 2023 09:15 AM (EST)',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    amount: '$22,100.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP3-001',
    customer: 'Omega Corp',
    created: 'Jun 01, 2022',
    due: 'Jul 01, 2022',
    presented: 'Jun 18, 2022',
    expected: 'Jul 01, 2022',
  ...
  },
  {
    ...
    amount: '$14,500.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP4-002',
    customer: 'Sigma Ltd',
    created: 'Jun 02, 2022',
    due: 'Jul 02, 2022',
    presented: 'Jun 19, 2022',
    expected: 'Jul 02, 2022',
    status: 'processed' as const,
    notes:
      'Ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi',
    paymentMethods: [
  ...
  },
  {
    ...
    amount: '$89,200.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP5-003',
    customer: 'Tau Industries',
    created: 'Jun 03, 2022',
    due: 'Jul 03, 2022',
    presented: 'Jun 20, 2022',
    expected: 'Jul 03, 2022',
    status: 'processed' as const,
    notes:
      'Ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi',
    paymentMethods: [
  ...
  },
  {
    ...
    amount: '$5,600.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP6-004',
    customer: 'Upsilon Inc',
    created: 'Jun 04, 2022',
    due: 'Jul 04, 2022',
    presented: 'Jun 21, 2022',
    expected: 'Jul 04, 2022',
    status: 'processed' as const,
    notes:
      'Ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi',
    paymentMethods: [
  ...
  },
  {
    ...
    amount: '$31,400.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP7-005',
    customer: 'Phi Group',
    created: 'Jun 06, 2022',
    due: 'Jul 06, 2022',
    presented: 'Jun 22, 2022',
    expected: 'Jul 06, 2022',
    status: 'processed' as const,
    notes:
      'Ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi',
    paymentMethods: [
  ...
  },
  {
    ...
    amount: '$17,800.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP8-006',
    customer: 'Chi Services',
    created: 'Jun 07, 2022',
    due: 'Jul 07, 2022',
    presented: 'Jun 23, 2022',
    expected: 'Jul 07, 2022',
    status: 'processed' as const,
    notes:
      'Ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi',
    paymentMethods: [
  ...
  },
  {
    ...
    amount: '$52,300.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP9-007',
    customer: 'Psi Partners',
    created: 'Jun 09, 2022',
    due: 'Jul 09, 2022',
    presented: 'Jun 24, 2022',
    expected: 'Jul 09, 2022',
    status: 'processed' as const,
    notes:
      'Ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi',
    paymentMethods: [
  ...
  },
  {
    ...
    amount: '$12,900.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP10-008',
    customer: 'Omega Plus',
    created: 'Jun 10, 2022',
    due: 'Jul 10, 2022',
    presented: 'Jun 26, 2022',
    expected: 'Jul 10, 2022',
    status: 'processed' as const,
    notes:
      'Ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi',
    paymentMethods: [
  ...
  },
  {
    ...
    amount: '$45,600.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP11-009',
    customer: 'Alpha Beta',
    created: 'Jun 11, 2022',
    due: 'Jul 11, 2022',
    presented: 'Jun 27, 2022',
    expected: 'Jul 11, 2022',
    status: 'processed' as const,
    notes:
      'Ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi',
    paymentMethods: [
  ...
  },
  {
    ...
    amount: '$28,700.00',
    amountCurrency: 'USD',
    invoiceNumber: 'IP12-010',
    customer: 'Gamma Delta',
    created: 'Jun 12, 2022',
    due: 'Jul 12, 2022',
    presented: 'Jun 28, 2022',
    expected: 'Jul 12, 2022',
    status: 'processed' as const,
    notes:
      'Ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas rhoncus aliquam lacus morbi',
    paymentMethods: [
    ...
    activityLog: [
      {
        ...
        status: 'paid',
        description:
          'Bill for receivable id #2345REQ3 has been paid with SMART Collect with payment type: Card Payment',
        timestamp: 'Aug 29, 2023 10:40 AM (EST)',
      },
      {
        id: 'al-2',
  ...
  ...Array.from({ length: 20 }, (_, i) => {
    const types: Array<'smartCollect' | 'bank' | 'card' | 'rfp' | 'ach'> = [
      'smartCollect',
      'bank',
      'card',
      'rfp',
    ...
    activityLog: [
      {
        ...
        status: 'failed',
        description:
          'Bill for receivable id #2345REQ3 failed due to internal error',
        timestamp: 'Aug 29, 2023 10:40 AM (EST)',
      },
      {
        id: 'al-ex-2',
  ...
  },
  {
    ...
    amount: '$45,000.00',
    amountCurrency: 'USD',
    invoiceNumber: 'EX2-001',
    customer: 'Exception Co.',
    created: 'Jun 05, 2022',
    due: 'Jul 05, 2022',
    presented: '-',
    expected: '-',
    status: 'failed' as const,
    notes: 'Bank account closed.',
