...
const AccountDetails = ({
  ...
  const smartEmail = smartDisburseContacts.find(
    (item) => item.type === 'email'
  );
  const smartPhone = smartDisburseContacts.find(
  ...
  const rows: DetailRow[] = isSmartDisburse
    ...
    : isCard
      ? [
          ...
          {
            label: 'Number',
            value: isRevealed ? '5454 8282 8282 8282' : '••••8282',
          },
          ...
          { label: 'Expires', value: '12 / 2024' },
          {
            label: 'Type',
            value: (
              <img src={MastercardFlag} alt="Mastercard" className="h-4 w-6" />
            ),
          },
          {
      ...
      : [
          { label: 'Account Holder Name', value: 'Big Kahuna Burger Ltd' },
          {
            ...
            value: isRevealed ? '123455667' : '•••••5667',
          },
          {
