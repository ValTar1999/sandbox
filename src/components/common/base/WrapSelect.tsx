...
function WrapSelect({
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener('wrapselect:open', handler as EventListener);
  }, [selectId]);
                    ...
                    <Tooltip trigger="hover" placement="top">
                      ...
                      >
                        <Badge
                          ...
                          size={selectedOption.badgeSize ?? 'sm'}
                          rounded={
                            selectedOption.badgeSecondaryRounded !== false
                          }
                        >
                          {selectedOption.badgeSecondary}
                        </Badge>
                            ...
                            <div className="flex items-center gap-1.5 flex-shrink-0">
                                  ...
                                  <Tooltip trigger="hover" placement="top">
                                    ...
                                    >
                                      <Badge
                                        ...
                                        rounded={option.badgeRounded !== false}
                                        icon={option.badgeIcon}
                                        iconDirection={
                                          option.badgeIconDirection
                                        }
                                      >
                                        {option.badge}
                                      </Badge>
                              ...
                              {option.badgeSecondary &&
                                (option.badgeSecondaryTooltip ? (
                                  <Tooltip trigger="hover" placement="top">
                                    ...
                                    >
                                      <Badge
                                        size={option.badgeSize ?? 'sm'}
                                        color={
                                          option.badgeSecondaryColor ?? 'gray'
                                        }
                                        rounded={
                                          option.badgeSecondaryRounded !== false
                                        }
                                      >
                                        {option.badgeSecondary}
                                      </Badge>
                                    </TooltipTrigger>
                                    <TooltipContent className="bg-gray-900 text-white w-[343px] px-3 py-2.5 rounded-lg">
                                      {option.badgeSecondaryTooltip}
                                    </TooltipContent>
                                  </Tooltip>
                                ) : (
                                  <Badge
                                    size={option.badgeSize ?? 'sm'}
                                    color={option.badgeSecondaryColor ?? 'gray'}
                                    rounded={
                                      option.badgeSecondaryRounded !== false
                                    }
                                  >
                          ...
                          <Tooltip trigger="hover" placement="top">
                            ...
                            >
                              <Badge
                                color={option.badgeSecondaryColor ?? 'gray'}
                                size={option.badgeSize ?? 'sm'}
                                rounded={option.badgeSecondaryRounded !== false}
                              >
                                {option.badgeSecondary}
                              </Badge>
                            </TooltipTrigger>
              ...
              {showInactiveNotice && option.inactive && (
                ...
                >
                  ...
                  <div className="text-medium text-sm leading-5 text-yellow-700">
                    This bank account is inactive.{' '}
                    <span className="font-semibold">Click here</span> to resolve
                    this issue.
                  </div>
                </a>
              )}
