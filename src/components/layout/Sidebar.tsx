...
const COMMON_CLASSES = {
  ...
  textVisible:
    'opacity-100 max-w-full transition-[max-width,opacity] duration-500 ease-in-out',
  textHidden:
    'opacity-0 max-w-0 pointer-events-none transition-[max-width,opacity] duration-[800ms] ease-in-out',
  childLink:
  ...
  >
    <g filter="url(#filter0_d_6776_132084)">
      <rect
        ...
        height="28"
        rx="14"
        fill="url(#paint0_linear_6776_132084)"
      />
      <path
        d="M16.1768 18.4131L18.8647 16.8612C18.9752 16.7974 19.0433 16.6795 19.0433 16.5519V13.4481C19.0433 13.3205 18.9752 13.2026 18.8647 13.1388L16.1768 11.5869C16.0663 11.5231 15.9302 11.5231 15.8197 11.5869L13.1317 13.1388C13.0212 13.2026 12.9531 13.3205 12.9531 13.4481V16.5519C12.9531 16.6795 13.0212 16.7974 13.1317 16.8612L15.8197 18.4131C15.9302 18.4769 16.0663 18.4769 16.1768 18.4131Z"
        stroke="white"
        strokeWidth="0.714286"
      />
      <path
        d="M16.0019 6.07129L21.8012 9.41951M23.7343 10.5356V17.232M23.7343 19.4642L17.935 22.8124M16.0019 23.9285L10.2026 20.5802M8.26953 19.4642V12.7677M8.26953 10.5356L14.0688 7.18736"
        stroke="white"
        strokeWidth="0.714286"
        strokeLinecap="round"
      ...
      />
      <path
        d="M8.50112 11.4285C9.09285 11.4285 9.57255 10.9488 9.57255 10.3571C9.57255 9.76534 9.09285 9.28564 8.50112 9.28564C7.90938 9.28564 7.42969 9.76534 7.42969 10.3571C7.42969 10.9488 7.90938 11.4285 8.50112 11.4285Z"
        fill="white"
      />
      <path
        d="M8.50112 20.7141C9.09285 20.7141 9.57255 20.2345 9.57255 19.6427C9.57255 19.051 9.09285 18.5713 8.50112 18.5713C7.90938 18.5713 7.42969 19.051 7.42969 19.6427C7.42969 20.2345 7.90938 20.7141 8.50112 20.7141Z"
        fill="white"
      />
      <path
        d="M23.5011 20.7141C24.0929 20.7141 24.5725 20.2345 24.5725 19.6427C24.5725 19.051 24.0929 18.5713 23.5011 18.5713C22.9094 18.5713 22.4297 19.051 22.4297 19.6427C22.4297 20.2345 22.9094 20.7141 23.5011 20.7141Z"
        fill="white"
      />
      <path
        d="M23.5011 11.4285C24.0929 11.4285 24.5725 10.9488 24.5725 10.3571C24.5725 9.76534 24.0929 9.28564 23.5011 9.28564C22.9094 9.28564 22.4297 9.76534 22.4297 10.3571C22.4297 10.9488 22.9094 11.4285 23.5011 11.4285Z"
        fill="white"
      />
      <path
        d="M16.0011 7.14286C16.5929 7.14286 17.0725 6.66316 17.0725 6.07143C17.0725 5.4797 16.5929 5 16.0011 5C15.4094 5 14.9297 5.4797 14.9297 6.07143C14.9297 6.66316 15.4094 7.14286 16.0011 7.14286Z"
        fill="white"
      />
      <path
        d="M16.0011 25C16.5929 25 17.0725 24.5203 17.0725 23.9286C17.0725 23.3369 16.5929 22.8572 16.0011 22.8572C15.4094 22.8572 14.9297 23.3369 14.9297 23.9286C14.9297 24.5203 15.4094 25 16.0011 25Z"
        fill="white"
      />
    </g>
    <defs>
      <filter
        id="filter0_d_6776_132084"
        x="0"
        y="0"
        width="32"
        height="32"
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_6776_132084"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_6776_132084"
          result="shape"
        />
      </filter>
      <linearGradient
        id="paint0_linear_6776_132084"
        x1="16"
        y1="1"
        x2="16"
        y2="29"
...
const FeatureButton = memo<FeatureButtonProps>(({ label }) => (
  <button className="cursor-pointer flex items-center gap-2 group">
    <div className="border-2 border-gray-200 rounded-full border-dashed group-hover:border-blue-600 transition-all duration-300">
      <Icon
        icon="plus"
        className="w-5 h-5 text-gray-400 m-1 group-hover:text-blue-600 transition-all duration-300"
      />
    </div>
...
const AccountInfoContent = memo(() => {
  ...
  return (
    <div
      ...
      {...getFloatingProps({
        className:
          'absolute top-full left-0 right-0 w-full px-4 pb-4 bg-gray-50 space-y-3 z-10',
      })}
    >
      <div className="text-xs text-gray-500 leading-4">
        You can go to your account enrollment portal to update your business
        information or upgrade your product with additional features.
      </div>
...
const AccountInfoContentTooltip = memo(() => (
  <div className="w-[296px] bg-white shadow-md rounded-lg p-4 space-y-3">
    ...
    <div className="space-y-3">
      <div className="text-sm font-medium text-gray-700">Current Features</div>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <APARPaymentsIcon />
          <div className="text-sm font-medium text-gray-800">
  ...
  <>
    <div className="space-y-2 px-4 py-4.5">
      ...
      <div className="space-y-1.5 text-sm text-gray-500">
        ...
        <CopyableText text="800-890-3128">800-890-3128</CopyableText>
      </div>
    </div>
    <a
      href="#"
  ...
  const renderMenuItem = useCallback(
    (item: MenuItem, index: number) => {
      ...
      const iconClasses = clsx(
        COMMON_CLASSES.icon,
        applyActiveStyles
          ? COMMON_CLASSES.iconActive
          : COMMON_CLASSES.iconInactive
      );

      const labelClasses = clsx(
        COMMON_CLASSES.label,
        applyActiveStyles
          ? COMMON_CLASSES.labelActive
          : COMMON_CLASSES.labelInactive
      );
      ...
      return (
        <div key={item.to}>
          ...
          {item.line && !isLastItem && (
            <hr className="border-bottom my-3 w-full border-gray-200" />
          )}
        </div>
      );
      ...
      <div className="flex flex-col items-center mt-auto space-y-2">
        <div className="flex w-full flex-grow items-center justify-center">
          <div className="flex items-center">
            ...
            >
              <div className="ml-1 text-xs font-medium leading-4 text-gray-500 text-nowrap whitespace-nowrap">
                Powered by
              </div>
              <img
                src={TranscardText}
