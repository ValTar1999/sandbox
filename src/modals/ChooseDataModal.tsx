...
const ChooseDataModal: React.FC<ChooseDataModalProps> = ({
  open,
  onClose,
  onConfirm,
  dueDate,
  ...
  return (
    <LayoutModal>
      <WrapModal
        className="w-128"
        onClose={onClose}
        header={<div>Schedule for Later</div>}
        footer={
          ...
          <div className="flex items-start gap-3 rounded-lg bg-gray-50 p-4">
            <div className="grid gap-1 text-xs">
              ...
              <div className="text-xs text-gray-500">
                Please note that all scheduled payments will be submitted on
                selected date starting from 9 AM (ET).
              </div>
            </div>
          </div>
        </div>
        <div className="grid px-2">
          <div className="border-t border-gray-200 px-4 py-4 text-lg font-medium">
            Recommended
          </div>
          <div className="pb-6">
