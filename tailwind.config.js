...
const classBadgeColors = BadgeColors.map(
  (color) =>
    `text-${color}-800 text-${color}-400 bg-${color}-100 border-${color}-200 ring-${color}-200`
);
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'dark-blue-gradient':
          'linear-gradient(180deg, #02296C -26%, #011A46 100%)',
        'collect-gradient':
          'linear-gradient(31deg, #0295C9 -23%, #0CD2E1 111%)',
